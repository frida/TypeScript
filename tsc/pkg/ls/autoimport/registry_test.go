...
import (
	...
	"github.com/frida/TypeScript/tsc/pkg/testutil/autoimporttestutil"
	"github.com/frida/TypeScript/tsc/pkg/testutil/contentmappertest"
	"github.com/frida/TypeScript/tsc/pkg/testutil/projecttestutil"
...
func TestHiddenDirectoriesInNodeModules(t *testing.T) {
	...
	t.Run("deep import through subdirectory package.json in hidden store", func(t *testing.T) {
		...
		// See https://github.com/frida/TypeScript/tsc/issues/2780
		t.Parallel()
